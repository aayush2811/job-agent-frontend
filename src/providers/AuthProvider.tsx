...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const handleEnterDemoMode = async () => {
    ...
    try {
      ...
      alert('Failed to boot Demo Mode. Make sure your backend server is running on port 5000.');
    }
  };
  ...
  if (showFailsafeUI && !hasHydrated) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-md glass-card border border-border/50 rounded-xl p-8 shadow-2xl z-10 space-y-6 text-center">
